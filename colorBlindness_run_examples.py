...
def main():
    ...
    Core.simulate(input_path='Examples_Check/rabbit.jpg',
                  return_type='save',
    ...
    Core.simulate(input_path='Examples_Check/ex_corrected_hybrid.png',
                return_type='save',
                save_path='Examples_Check/ex_simulate_corrected_hybrid.png',
                simulate_type='hybrid',
